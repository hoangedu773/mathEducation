...
- Use `design-taste` skill for reverse-engineering a website's design taste (/taste <url>) — extracts design tokens (colors, typography, spacing, radii, shadows) and taste DNA (trade-offs explaining WHY) via Playwright MCP DOM extractor. Outputs taste.md + taste.json for downstream build tools.
